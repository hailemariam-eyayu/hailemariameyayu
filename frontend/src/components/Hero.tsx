      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 flex flex-col lg:flex-row items-center gap-16">
        ...
        <div className="flex-1 text-center lg:text-left animate-slide-up">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-white leading-tight mb-4">
            Hi, I'm{' '}
            <span className="text-gradient">Hailemariam</span>
          </h1>
          ...
          <p className="text-gray-400 text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 mb-10">
            Passionate software engineer with 5+ years of experience building modern web and mobile
            applications. I turn ideas into elegant, performant products.
          </p>
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  if (parent) {
                    ...
                    parent.innerHTML = '<span class="text-6xl font-black text-white">HE</span>';
                  }
                }}
              />
            </div>
